...
var DatePicker = new Class({
	...
	create: function(fade){
		...
		this.options.monthNames.each(function(item,index){
			this.monthSel.options[index] = new Element('option', {value: index});
			this.monthSel.options[index].set('text',item);
			if (this.month == index) this.monthSel.options[index].set('selected','selected');
		}.bind(this));
		
		/* create the year select box */
		//this.yearSel = new Element('div', {'text':this.year});
		...
		years.each(function(y,i){
			this.yearSel.options[i] = new Element('option',{value: y});
			this.yearSel.options[i].set('text',y);
			if (this.year == y) this.yearSel.options[i].set('selected','selected');			
		}.bind(this));
		...
		this.yearSel.injectInside(calSelCell);
